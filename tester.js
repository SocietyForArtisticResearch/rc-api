...
var $author$project$Tester$Loading = {$: 'Loading'};
...
var $author$project$Tester$GotExpo = function (a) {
	return {$: 'GotExpo', a: a};
};
var $author$project$ParsedExpo$ParsedExpo = F4(
	function (meta, id, copyrights, pages) {
		return {copyrights: copyrights, id: id, meta: meta, pages: pages};
	});
var $author$project$ParsedExpo$Copyright = F6(
	function (copyrightHolder, id, license, name, toolLink, usages) {
		return {copyrightHolder: copyrightHolder, id: id, license: license, name: name, toolLink: toolLink, usages: usages};
	});
...
var $author$project$Licenses$fromString = function (str) {
	switch (str) {
		case 'all-rights-reserved':
			return $author$project$Licenses$AllRightsReserved;
		case 'cc-by':
			return $author$project$Licenses$CCBY;
		case 'cc-by-nc':
			return $author$project$Licenses$CCBYNC;
		case 'cc-by-nc-nd':
			return $author$project$Licenses$CCBYNCND;
		case 'cc-by-nc-sa':
			return $author$project$Licenses$CCBYNCSA;
		case 'public-domain':
			return $author$project$Licenses$PublicDomain;
		default:
			return $author$project$Licenses$AllRightsReserved;
	}
};
...
var $author$project$Expo$ToolId = function (a) {
	return {$: 'ToolId', a: a};
};
...
var $author$project$ParsedExpo$toolIds = A2(
	$elm$json$Json$Decode$map,
	function (lst) {
		var maybeTool = A2(
			$elm$core$Basics$composeR,
			A2($elm$core$String$replace, 'tool-', ''),
			A2(
				$elm$core$Basics$composeR,
				$elm$core$String$toInt,
				$elm$core$Maybe$map($author$project$Expo$ToolId)));
		return A2($elm$core$List$filterMap, maybeTool, lst);
	},
	$elm$json$Json$Decode$list($elm$json$Json$Decode$string));
var $author$project$ParsedExpo$toolUrls = A2(
	$elm$json$Json$Decode$map,
	$elm$core$List$filterMap($elm$url$Url$fromString),
	$elm$json$Json$Decode$list($elm$json$Json$Decode$string));
var $elm$json$Json$Decode$oneOf = _Json_oneOf;
var $author$project$ParsedExpo$usages = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$map,
...
var $author$project$ParsedExpo$decodeCopyrights = A7(
	$elm$json$Json$Decode$map6,
	$author$project$ParsedExpo$Copyright,
	A2($elm$json$Json$Decode$field, 'copyright', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'id', $author$project$ParsedExpo$toolIds),
	A2(
		$elm$json$Json$Decode$field,
		'license',
		A2($elm$json$Json$Decode$map, $author$project$Licenses$fromString, $elm$json$Json$Decode$string)),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'tool', $author$project$ParsedExpo$toolUrls),
	A2($elm$json$Json$Decode$field, 'usages', $author$project$ParsedExpo$usages));
...
var $author$project$Research$DOI = function (a) {
	return {$: 'DOI', a: a};
};
var $author$project$Research$decodeDoi = A2(
	$elm$json$Json$Decode$map,
	$author$project$Research$DOI,
...
var $author$project$Research$mkResearch = function (e) {
	return function (t) {
		return function (kw) {
			return function (cr) {
				return function (au) {
					return function (iss) {
						return function (pubstat) {
							return function (pub) {
								return function (thumb) {
									return function (abs) {
										return function (def) {
											return function (portals) {
												return function (connected_to) {
													return function (lastModified) {
														return function (modifiedPosix) {
															return function (doi) {
																return {
																	_abstract: abs,
																	author: au,
																	...
																	portals: portals,
																	publication: pub,
																	publicationStatus: A2($elm$core$Maybe$withDefault, $author$project$Research$Undecided, pubstat),
																	thumbnail: thumb,
																	title: t
																};
															};
...
var $author$project$Research$pubDatePosix = A2(
	$elm$json$Json$Decode$map,
	function (psx) {
		return $elm$time$Time$millisToPosix(psx * 1000);
	},
...
var $author$project$Research$dmyToYmd = function (dmy) {
	...
	if (((parts.b && parts.b.b) && parts.b.b.b) && (!parts.b.b.b.b)) {
		...
		var _v3 = A2($elm$core$String$split, '-', dmy);
		if (((_v3.b && _v3.b.b) && _v3.b.b.b) && (!_v3.b.b.b.b)) {
			...
			return $elm$core$Result$Err('a json date has an unexpected shape' + dmy);
		}
	}
};
	...
	$elm$core$Result$mapError(
		A2(
			...
			A2(
				...
				$elm$core$Maybe$withDefault('')))));
var $author$project$Research$dateFromRCString = function (str) {
	return A2(
		$elm$core$Result$andThen,
		$justinmimbs$date$Date$fromIsoString,
		$author$project$Research$dmyToYmd(str));
};
...
var $author$project$Research$pubDateString = A2(
	$elm$json$Json$Decode$andThen,
	function (dateStr) {
		return $elm_community$json_extra$Json$Decode$Extra$fromResult(
			$author$project$Research$dateFromRCString(dateStr));
	},
	$elm$json$Json$Decode$string);
...
var $author$project$Research$pubDateStringFromPosix = A2(
	$elm$json$Json$Decode$map,
	$justinmimbs$date$Date$fromPosix($elm$time$Time$utc),
	$author$project$Research$pubDatePosix);
...
var $author$project$Research$decoder = A2(
	$elm_community$json_extra$Json$Decode$Extra$andMap,
	$elm$json$Json$Decode$maybe(
		A2($elm$json$Json$Decode$field, 'doi', $author$project$Research$decodeDoi)),
	A2(
		$elm_community$json_extra$Json$Decode$Extra$andMap,
		A2($elm$json$Json$Decode$field, 'last-modified', $author$project$Research$pubDatePosix),
		A2(
			$elm_community$json_extra$Json$Decode$Extra$andMap,
			A2($elm$json$Json$Decode$field, 'last-modified', $author$project$Research$pubDateStringFromPosix),
			A2(
				$elm_community$json_extra$Json$Decode$Extra$andMap,
				A2(
					$elm$json$Json$Decode$field,
				...
				A2(
					...
					A2(
						$elm_community$json_extra$Json$Decode$Extra$andMap,
						A2($elm$json$Json$Decode$field, 'default-page', $elm$json$Json$Decode$string),
						A2(
							$elm_community$json_extra$Json$Decode$Extra$andMap,
							$elm$json$Json$Decode$maybe(
							...
							A2(
								...
								A2(
									$elm_community$json_extra$Json$Decode$Extra$andMap,
									$elm$json$Json$Decode$maybe(
										A2($elm$json$Json$Decode$field, 'published', $author$project$Research$pubDateString)),
									A2(
										$elm_community$json_extra$Json$Decode$Extra$andMap,
										A2(
											$elm$json$Json$Decode$map,
											...
											A2(
												...
												A2(
													...
													A2(
														$elm$json$Json$Decode$field,
														'created',
														A2($elm$json$Json$Decode$map, $justinmimbs$date$Date$toIsoString, $author$project$Research$pubDateString)),
													A2(
														$elm_community$json_extra$Json$Decode$Extra$andMap,
														A2(
															$elm$json$Json$Decode$map,
														...
														A2(
															...
															A2(
																$elm_community$json_extra$Json$Decode$Extra$andMap,
																A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
																$elm$json$Json$Decode$succeed($author$project$Research$mkResearch)))))))))))))))));
var $author$project$ParsedExpo$decodeExpositionMeta = $author$project$Research$decoder;
var $author$project$ParsedExpo$ParsedPage = F5(
	function (pageId, pageHyperlinks, tools, weaveType, metrics) {
		return {metrics: metrics, pageHyperlinks: pageHyperlinks, pageId: pageId, tools: tools, weaveType: weaveType};
	});
var $author$project$Stats$Metrics = F7(
	function (alignmentScore, spacingScore, sizeUniformityScore, overlapPercentage, whiteSpacePercentage, horizontalVerticalRatio, overallRegularScore) {
		return {alignmentScore: alignmentScore, horizontalVerticalRatio: horizontalVerticalRatio, overallRegularScore: overallRegularScore, overlapPercentage: overlapPercentage, sizeUniformityScore: sizeUniformityScore, spacingScore: spacingScore, whiteSpacePercentage: whiteSpacePercentage};
	});
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $elm$json$Json$Decode$map7 = _Json_map7;
var $author$project$Stats$decodeMetrics = function () {
	var _float = $elm$json$Json$Decode$float;
	return A8(
		$elm$json$Json$Decode$map7,
		$author$project$Stats$Metrics,
		A2($elm$json$Json$Decode$field, 'alignment_score', _float),
		A2($elm$json$Json$Decode$field, 'spacing_score', _float),
		A2($elm$json$Json$Decode$field, 'size_uniformity_score', _float),
		A2($elm$json$Json$Decode$field, 'overlap_percentage', _float),
		A2($elm$json$Json$Decode$field, 'white_space_percentage', _float),
		A2($elm$json$Json$Decode$field, 'horizontal_vertical_ratio', _float),
		A2($elm$json$Json$Decode$field, 'overall_regular_score', _float));
}();
var $author$project$Expo$Block = {$: 'Block'};
var $author$project$Expo$Graphical = {$: 'Graphical'};
var $author$project$Expo$Iframe = {$: 'Iframe'};
var $author$project$Expo$Text = {$: 'Text'};
var $author$project$Expo$Unknown = function (a) {
	return {$: 'Unknown', a: a};
};
var $author$project$Expo$pageTypeOfString = function (str) {
	switch (str) {
		case 'weave-graphical':
			return $author$project$Expo$Graphical;
		case 'weave-text':
			return $author$project$Expo$Text;
		case 'weave-block':
			return $author$project$Expo$Block;
		case 'weave-iframe':
			return $author$project$Expo$Iframe;
		default:
			var other = str;
			return $author$project$Expo$Unknown(other);
	}
};
var $author$project$ParsedExpo$decodePageType = A2($elm$json$Json$Decode$map, $author$project$Expo$pageTypeOfString, $elm$json$Json$Decode$string);
var $author$project$ParsedExpo$ParsedTool = function (id) {
									...
									return function (style) {
										return function (tool) {
											return function (usages) {
												return {content: content, copyright: copyright, dimensions: dimensions, id: id, lastModified: lastModified, lastModifiedBy: lastModifiedBy, license: license, name: name, src: src, style: style, tool: tool, usages: usages};
											};
										};
									};
								};
...
var $author$project$ParsedExpo$decodeIsoDate = A2(
	$elm$json$Json$Decode$andThen,
	function (str) {
		var _v0 = $rtfeldman$elm_iso8601_date_strings$Iso8601$toTime(str);
		if (_v0.$ === 'Ok') {
			var psx = _v0.a;
			return $elm$json$Json$Decode$succeed(psx);
		} else {
			var e = _v0.a;
			return $elm$json$Json$Decode$fail(
				'error: ' + $elm$parser$Parser$deadEndsToString(e));
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Expo$CartDim = function (a) {
	return {$: 'CartDim', a: a};
};
var $author$project$ParsedExpo$decodeParsedDimensions = function () {
	var dimensionsFromList = function (lst) {
		if ((((lst.b && lst.b.b) && lst.b.b.b) && lst.b.b.b.b) && (!lst.b.b.b.b.b)) {
			var left = lst.a;
			var _v1 = lst.b;
			var top = _v1.a;
			var _v2 = _v1.b;
			...
			return $elm$json$Json$Decode$succeed(
				$author$project$Expo$CartDim(
					{h: height, left: left, top: top, w: width}));
		} else {
			var wrongLst = lst;
			return $elm$json$Json$Decode$fail(
				'invalid position format' + A2(
					$elm$core$String$join,
					' ',
					A2($elm$core$List$map, $elm$core$String$fromInt, wrongLst)));
		}
	};
	return A2(
		$elm$json$Json$Decode$andThen,
...
var $author$project$ParsedExpo$MediaResource = function (a) {
	return {$: 'MediaResource', a: a};
};
...
var $author$project$ParsedExpo$mkMediaResource = function (urlString) {
	var fromUrl = function (url) {
		var string2posix = function (secondsString) {
			return A2(
				$elm$core$Maybe$map,
				$elm$time$Time$millisToPosix,
				$elm$core$String$toInt(secondsString));
		};
		...
		var end = A2(
			...
			A2(
				$elm$core$Maybe$andThen,
				$elm$core$List$head,
				A2($elm$core$Dict$get, 'e', appurl.queryParameters)));
		return $author$project$ParsedExpo$MediaResource(
			{src: url, timeout: end});
	};
	return A2(
		$elm$core$Maybe$map,
...
var $author$project$ParsedExpo$decodeParsedTool = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'usages',
	$author$project$ParsedExpo$usages,
	_List_Nil,
	A3(
		...
		A3(
			...
			A4(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
				'src',
				A2($elm$json$Json$Decode$map, $author$project$ParsedExpo$mkMediaResource, $elm$json$Json$Decode$string),
				$elm$core$Maybe$Nothing,
				A4(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
					'name',
					...
					A4(
						...
						A2(
							$elm$json$Json$Decode$map,
							A2($elm$core$Basics$composeR, $author$project$Licenses$fromString, $elm$core$Maybe$Just),
							$elm$json$Json$Decode$string),
						$elm$core$Maybe$Nothing,
						A4(
							$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
							...
							A4(
								$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
								'last-modified-at',
								A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $author$project$ParsedExpo$decodeIsoDate),
								$elm$core$Maybe$Nothing,
								A3(
									$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
									'dimensions',
									$author$project$ParsedExpo$decodeParsedDimensions,
									A4(
										$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
										'copyright',
										A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $elm$json$Json$Decode$string),
										...
										A3(
											...
											A3(
												...
												'id',
												$elm$json$Json$Decode$string,
												$elm$json$Json$Decode$succeed($author$project$ParsedExpo$ParsedTool)))))))))))));
var $elm$json$Json$Decode$keyValuePairs = _Json_decodeKeyValuePairs;
var $author$project$ParsedExpo$decodeToolsDict = $elm$json$Json$Decode$keyValuePairs(
	$elm$json$Json$Decode$list($author$project$ParsedExpo$decodeParsedTool));
var $author$project$Hyperlinks$Hyperlinks = F5(
	function (external, other_expositions, references, same_exposition, simpleurls) {
		return {external: external, other_expositions: other_expositions, references: references, same_exposition: same_exposition, simpleurls: simpleurls};
	});
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Hyperlinks$stringList = $elm$json$Json$Decode$list($elm$json$Json$Decode$string);
var $author$project$Hyperlinks$maybeSimpleUrls = A2(
	$elm$json$Json$Decode$andThen,
	function (maybe) {
		return $elm$json$Json$Decode$succeed(
	...
	$elm$json$Json$Decode$maybe(
		A2($elm$json$Json$Decode$field, 'simpleurls', $author$project$Hyperlinks$stringList)));
var $author$project$Hyperlinks$hyperlinksDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Hyperlinks$Hyperlinks,
	A2($elm$json$Json$Decode$field, 'external', $author$project$Hyperlinks$stringList),
	A2($elm$json$Json$Decode$field, 'other_expositions', $author$project$Hyperlinks$stringList),
	A2($elm$json$Json$Decode$field, 'references', $author$project$Hyperlinks$stringList),
	A2($elm$json$Json$Decode$field, 'same_exposition', $author$project$Hyperlinks$stringList),
	$author$project$Hyperlinks$maybeSimpleUrls);
var $author$project$ParsedExpo$decodePage = A6(
	$elm$json$Json$Decode$map5,
	$author$project$ParsedExpo$ParsedPage,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'hyperlinks', $author$project$Hyperlinks$hyperlinksDecoder),
	A2($elm$json$Json$Decode$field, 'tools', $author$project$ParsedExpo$decodeToolsDict),
	A2($elm$json$Json$Decode$field, 'type', $author$project$ParsedExpo$decodePageType),
	A2($elm$json$Json$Decode$field, 'metrics', $author$project$Stats$decodeMetrics));
var $elm$core$Tuple$second = function (_v0) {
	var y = _v0.b;
	return y;
};
var $author$project$ParsedExpo$decodePages = A2(
	$elm$json$Json$Decode$map,
	$elm$core$List$map($elm$core$Tuple$second),
	$elm$json$Json$Decode$keyValuePairs($author$project$ParsedExpo$decodePage));
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$ParsedExpo$decodeParsedExposition = A5(
	$elm$json$Json$Decode$map4,
	$author$project$ParsedExpo$ParsedExpo,
	A2($elm$json$Json$Decode$field, 'meta', $author$project$ParsedExpo$decodeExpositionMeta),
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2(
		$elm$json$Json$Decode$field,
		'copyrights',
		$elm$json$Json$Decode$list($author$project$ParsedExpo$decodeCopyrights)),
	A2($elm$json$Json$Decode$field, 'pages', $author$project$ParsedExpo$decodePages));
...
var $author$project$Tester$fetchConfig = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Tester$GotExpo, $author$project$ParsedExpo$decodeParsedExposition),
		url: 'test1.json'
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Tester$Failure = function (a) {
	return {$: 'Failure', a: a};
};
var $author$project$Tester$Success = function (a) {
	return {$: 'Success', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Tester$update = F2(
	function (msg, model) {
		var result = msg.a;
		if (result.$ === 'Ok') {
			var expo = result.a;
			return _Utils_Tuple2(
				$author$project$Tester$Success(expo),
				$elm$core$Platform$Cmd$none);
		} else {
			var err = result.a;
			return _Utils_Tuple2(
				$author$project$Tester$Failure(err),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Tester$view = function (model) {
	switch (model.$) {
		case 'Loading':
			return $elm$html$Html$text('Loading…');
		case 'Success':
			return $elm$html$Html$text('It worked!');
		default:
			var error = model.a;
...
var $author$project$Tester$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$Tester$Loading, $author$project$Tester$fetchConfig);
		},
		subscriptions: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Tester$update,
		view: $author$project$Tester$view
	});
_Platform_export({'Tester':{'init':$author$project$Tester$main(
